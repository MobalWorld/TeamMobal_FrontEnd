...
import 'package:mobalworld/src/worry_miri.dart';
      ...
      child: Scaffold(
        ...
        body: Column(
          ...
          children: [
            ...
            Padding(
              padding:
                  EdgeInsets.symmetric(horizontal: 0.02.sh, vertical: 0.02.sh),
              child: Container(
                height: 0.15.sh,
                            ...
                            onPressed: () {
                              showDialog(
                                ...
                                builder: (context) => AlertDialog(
                                  title: Text('알림'),
                                  content: Text('고민에 대한 응답은 한번밖에 할 수 없어요! 진심을 담은 고민 답변 부탁드립니다 🧡'),
                                  actions: [
                                    TextButton(
                                      onPressed: () {
